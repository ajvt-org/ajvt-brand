#!/usr/bin/env python3
"""
Draws logos/src/marks/ajvt-cup.svg — the association cup mark.

    python3 tools/draw/ajvt-cup.py
...
HEADER = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <!--
    GENERATED by tools/draw/ajvt-cup.py. Do not hand-edit the path data.
...
out = os.path.join(os.path.dirname(__file__), "..", "..", "logos", "src", "marks", "ajvt-cup.svg")
